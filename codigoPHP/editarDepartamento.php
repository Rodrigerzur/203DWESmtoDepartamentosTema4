...
if(isset($_REQUEST['cancelar'])){//Si pulsa el botón de cancelar
    ...
    if(isset($_REQUEST['aceptar'])){ //Si se ha enviado el formulario
        ...
        try{
            ...
            $errorExcepcion = $excepcion->getCode();//Guardar el codigo de error
            $mensajeExcepcion = $excepcion->getMessage();//Guardar el mensaje de excepcon
            ...
            <form name="formulario" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" class="formularioAlta">
                <div>
                    ...
                    <input type="text" id="CodDepartamento" name="CodDepartamento" value="" 
                           placeholder="<?php echo($_REQUEST['CodDepartamentoEnCurso']);?>" readonly>
                    <br><br>
                    ...
                    <label style="font-weight: bold;" class="FechaBaja" for="FechaBaja">Fecha de Baja </label>
                    <input type="text" id="FechaBaja" name="FechaBaja" value="<?php echo(isset($_REQUEST['FechaBaja']) ? $_REQUEST['FechaBaja'] : null); ?>" readonly>
                    <br><br>
